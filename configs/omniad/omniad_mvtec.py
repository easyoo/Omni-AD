...
class cfg(cfg_common, cfg_dataset_default):
	...
	def __init__(self):
		...
		self.data.root = '/home/jjquan/datasets/mvtec'
		...
		self.model_t.kwargs = dict(pretrained=True, checkpoint_path='model/pretrain/resnet34-43635321.pth',
								   strict=False, features_only=True, out_indices=[1, 2, 3])
		self.model_s = dict(
			depths_decoder=[3, 9, 9, 7],
		)
		self.model = Namespace()
		self.model.name = 'omniAD'
		...
		# ==> trainer
		self.trainer.name = 'OmniadTrainer'
